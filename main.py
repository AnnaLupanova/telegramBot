...
API_TOKEN = '5063014774:AAETJKnHT21qJvHtMSJ2nQvFuZ8Nk-oBNHI'
#TELEGRAM_ACCESS_ID = ['701722851', '5015235403']
# Configure logging
TELEGRAM_ACCESS_ID = list(db.get_user())
user = []
for el in TELEGRAM_ACCESS_ID:
    user.append(el[0])
...
dp = Dispatcher(bot)
dp.middleware.setup(AccessMiddleware(user))
...
async def list_expenses(message: types.Message):
    ...
    last_expenses_rows = [
        f"{expense.amount} руб. на категорию: {expense.category_name} — нажми "
...
async def add_expense(message: types.Message):
    ...
    try:
        ...
        return
    answer_message = (
        f"Добавлены траты {expense.amount} руб на категорию: {expense.category_name}.\n\n"
